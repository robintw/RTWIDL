...
;
; PURPOSE:
; This routine reads data from an Ocean Optics SpectraSuite format data file, containing spectra information.
;
; CALLING SEQUENCE:
;
; READ_OO_DATA_FILE, filename, wavelengths=wavelengths, dns=dns, datetime=datetime
;
; INPUTS:
; filename: The filepath of the file to read
;
; OUTPUTS:
; wavelengths: A float array containing the wavelengths of the spectrum measured (ie. the X axis of the spectrum graph)
;
; dns: A float array containing the Digital Numbers (DNs) of the spectrum measured (ie. the Y axis of the spectrum graph)
;
; datetime: The timestamp of the spectrum acquisition
;
